...
The basic distinction is that **Purse aims to be as close to the CoreGui** while **Satchel aims to be an improvement over the CoreGui**.
...
* **Sync with upstream**: We document changes and keep track of any deviations from the [CoreGui backpack upstream], which makes it easy to sync with upstream.
* **More APIs with documentation**: Purse includes additional APIs beyond what the CoreGui backpack provides, all [thoroughly documented](api-reference.md) for developers.
  ...
  [CoreGui backpack upstream]: https://github.com/MaximumADHD/Roblox-Client-Tracker/blob/roblox/scripts/CoreScripts/Modules/BackpackScript.lua
